...
draw_text(hud.aggregateLeftBound + 80, hud.aggregateLowerBound - (5 * string_height("Something")), "Shields: " + string(player.percentPPShields) + "%");
draw_text(hud.aggregateLeftBound, hud.aggregateLowerBound - (3 * string_height("Something")), "Guns: " + string(player.percentPPGuns) + "%");
draw_text(hud.aggregateLeftBound + 80, hud.aggregateLowerBound - (3 * string_height("Something")), "Cannon: " + string(player.percentPPCannon) + "%");
