            ...
            if(actionMap[? "Thrusters Clock"] > 0) {
                if(object_index == objRiceCake && actionMap[? "Passive"] == active) {
                    if(actionMap[? "Thrusters Clock"] >= 2) {
                        image_angle -= 180;
                        actionQueue[| ds_list_find_index(actionQueue, "Thrst#Clock#" + actionMap[? "Thrusters Clock"])] = "Thrst#Clock#" + string(actionMap[? "Thrusters Clock"] - 1);
            ...
            if(actionMap[? "Thrusters Count"] > 0) {
                if(object_index == objRiceCake && actionMap[? "Passive"] == active) {
                    if(actionMap[? "Thrusters Count"] >= 2) {
                        image_angle += 180;
                        actionQueue[| ds_list_find_index(actionQueue, "Thrst#Count#" + actionMap[? "Thrusters Count"])] = "Thrst#Count#" + string(actionMap[? "Thrusters Count"] - 1);
