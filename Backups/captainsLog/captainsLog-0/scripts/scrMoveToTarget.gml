...
if(position == left) {
    ...
    if(distance_to_point(target.x + 13, target.y + 22) >= 10) {
        if(image_angle == 90) {
            image_angle -= (90 / distance_to_point(target.x + 13, target.y + 22)) * 10;
        }
        move_towards_point(target.x + 13, target.y + 22, 10);
    } else if(distance_to_point(target.x + 13, target.y + 22) != 0) {
        if(image_angle == 90) {
            image_angle -= (90 / distance_to_point(target.x + 13, target.y + 22));
        }
    ...
    if(distance_to_point(target.x + 13, target.y + 3) >= 10) {
        if(image_angle == 90) {
            image_angle -= (90 / distance_to_point(target.x + 13, target.y + 3)) * 10;
        }
        move_towards_point(target.x + 13, target.y + 3, 10);
    } else if(distance_to_point(target.x + 13, target.y + 3) != 0) {
        if(image_angle == 90) {
            image_angle -= (90 / distance_to_point(target.x + 13, target.y + 3));
        }
